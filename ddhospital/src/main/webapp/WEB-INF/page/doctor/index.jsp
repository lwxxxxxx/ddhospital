...
<div class="layui-layout layui-layout-admin">
    <div class="layui-header">
        <div class="layui-logo" style="margin-left: 600px;color:#3F9F00;">医生诊断</div>
        <ul class="layui-nav layui-layout-right">
            <li class="layui-nav-item">
                <a href="javascript:;">
                    <img src="http://${sessionScope.doctor.bz}" class="layui-nav-img">
                    ${sessionScope.doctor.name}医生
                </a>
                <dl class="layui-nav-child">
                    <dd><a href="javascript:;" onclick="showTab('${pageContext.request.contextPath}/page_doctor/myInfo')">基本资料</a></dd>
        ...
        <div class="layui-side-scroll">
            ...
            <ul class="layui-nav layui-nav-tree" lay-shrink="all" lay-filter="test">
                <li class="layui-nav-item layui-nav-itemed">
                    <a class="" href="javascript:;">医生诊断</a>
                    <dl class="layui-nav-child">
                        <dd><a href="javascript:;" onclick="showTab('${pageContext.request.contextPath}/page_doctor/zdList')">诊断</a></dd>
                ...
                <li class="layui-nav-item">
                    ...
                    <dl class="layui-nav-child">
                        ...
                        <dd><a href="javascript:;" onclick="showTab('${pageContext.request.contextPath}/page_doctor/blList')">病例查看</a></dd>
                    </dl>
                </li>
                <li class="layui-nav-item">
